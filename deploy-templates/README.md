...
| serviceAccount.annotations | object | `{"eks.amazonaws.com/role-arn":"arn:aws:iam::183631338639:role/krci-cmtr-pg09s5mh-assume-role"}` | Annotations to add to the service account |
